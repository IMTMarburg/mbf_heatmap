...
module_dir = os.path.join(__location__, "../src/mbf_heatmap")
try:
...
try:
    from mbf_heatmap import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'mbf_heatmap-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'mbf_heatmap Documentation',
